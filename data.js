...
export const skills = [
  ...
  {
    keywords: ['Node', 'PHP', 'MySql', 'MongoDB', 'GraphQL'],
    level: 'Senior',
    name: 'Backend',
  },
  {
...
export const projects = [
  ...
  },
  {
    ...
    description: {
      info:
        'A system of integrated applications to manage all facets of operation in a single database, application and user interface.',
      detail:
        'It was the most complicated work. we had to work on many open source technologies to automate almost everything. Apart from common ERP modules, we worked on additional modules like finding and purchasing materials using different APIs to designing PCB Assembly layouts with data provided by the user.',
    },
    link: '',
    keywords:
