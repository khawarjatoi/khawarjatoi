...
const Social = () => (
  <Wrapper>
    <h3>CONTACT ME</h3>
    <a href="mailto:khawarjatoi@live.com" className="social_Email">
      khawarjatoi@live.com
    </a>
    <IconContainer>
      <a href="https://github.com/khawarjatoi" target="_blank">
        <svg
      ...
      <a href="https://www.linkedin.com/in/khawarjatoi" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1792 1792"
        >
      ...
      <a href="https://twitter.com/khawar_jatoi" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 1792 1792"
        >
      ...
      <a href="https://dev.to/khawar_jatoi" target="_blank">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 512 512"
        >
